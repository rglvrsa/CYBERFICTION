...
let button=document.querySelectorAll(".btn-posnawr");
button.forEach((e)=>{
...
gsap.from("#contacts .btn-posnawr1",{
  y:-200,
  opacity:0,
  scrollTrigger:{
    scroller:"#main",
...
gsap.from("#contacts .btn-posnawr2",{
  y:-230,
  opacity:0,
  scrollTrigger:{
    scroller:"#main",
...
gsap.from("#contacts .btn-posnawr3",{
  y:-250,
  opacity:0,
  scrollTrigger:{
    scroller:"#main",
...
gsap.from("#contacts .btn-posnawr4",{
  y:-270,
  opacity:0,
  scrollTrigger:{
    scroller:"#main",
